...
extern PCSTR c_missileIntrospectionXml;

ref class missileProducer;

public interface class ImissileProducer
{
    event Windows::Foundation::TypedEventHandler<missileProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    event Windows::Foundation::TypedEventHandler<missileProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<missileProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<missileProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
};

public ref class missileProducer sealed : [Windows::Foundation::Metadata::Default] ImissileProducer
{
public:
    missileProducer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~missileProducer();

    // The implementation of ImissileService that will handle method calls and property requests.
    property ImissileService^ Service
    {
        ImissileService^ get() { return m_serviceInterface; }
        void set(ImissileService^ value) { m_serviceInterface = value; }
    }

    // Used to send signals or register functions to handle received signals.
    property missileSignals^ Signals
    {
        missileSignals^ get() { return m_signals; }
    }
    
    // This event will fire whenever this producer is stopped.
    virtual event Windows::Foundation::TypedEventHandler<missileProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    
    // This event will fire whenever the producer loses the session that it created.
    virtual event Windows::Foundation::TypedEventHandler<missileProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    
    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<missileProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<missileProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
...
private:
    static void CallLedHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    static void CallMoveHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    static void CallFireHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    ...
    missileSignals^ m_signals;
    ImissileService^ m_serviceInterface;
