...
public interface class ImissileConsumer
{
    event Windows::Foundation::TypedEventHandler<missileConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<missileConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<missileConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
};

public ref class missileConsumer sealed  : [Windows::Foundation::Metadata::Default] ImissileConsumer
{
public:
    missileConsumer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~missileConsumer();
    ...
    static Windows::Foundation::IAsyncOperation<missileJoinSessionResult^>^ JoinSessionAsync(_In_ Windows::Devices::AllJoyn::AllJoynServiceInfo^ serviceInfo, _Inout_ missileWatcher^ watcher);

    // Call the led method
    Windows::Foundation::IAsyncOperation<missileLedResult^>^ LedAsync(_In_ bool interfaceMemberOn);
    // Call the move method
    Windows::Foundation::IAsyncOperation<missileMoveResult^>^ MoveAsync(_In_ Platform::String^ interfaceMemberDirection, _In_ int32 interfaceMemberTime);
    // Call the fire method
    Windows::Foundation::IAsyncOperation<missileFireResult^>^ FireAsync();
    ...
    virtual event Windows::Foundation::TypedEventHandler<missileConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;

    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<missileConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<missileConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
